...
Tests all functionality across different storage backends.
"""

import pytest
import json
from  import LocalStoragePro
from .storage_backends import localStoragePyStorageException
...
class TestBasicOperations:
    ...
    def test_set_and_get_item(self):
        ...
        storage.setItem('email', 'contact@surajmandal.com')
        
        assert storage.getItem('username') == 'surajmandal'
        assert storage.getItem('email') == 'contact@surajmandal.com'
